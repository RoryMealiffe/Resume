...
-   Oversaw Tableau and SQL developers that created company wide reporting suite which included automating month end reporting, for Revenue, Expense and Sales. Reduced the time spent by the FP&A team on reporting financial by 5 days each month.
...
-   Built process using Python to code open ended survey comments via Semantria. Results displayed in a Tableau dashboard that allows product owners to quickly gain insight into customer feedback.
